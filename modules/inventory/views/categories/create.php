<div class="categories-create">
    <div class="page-header">
        <h1 class="page-title">Kategorie erstellen</h1>
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Neue Kategorie</h2>
            <p class="card-subtitle">Erstellen Sie eine neue Kategorie für Geräte</p>
        </div>
            ...
            <form method="POST" action="<?= route('categories.store') ?>" class="form">
                ...
                <div class="form-group">
                    ...
                    <select id="parent_id" name="parent_id" class="form-select">
                        ...
                        <?php foreach ($parentOptions as $id => $name): ?>
                            <option value="<?= e($id) ?>" <?= old('parent_id', '') == $id ? 'selected' : '' ?>>
                                <?= e($name) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    <label class="form-checkbox">
                        ...
                        <span class="form-checkbox-label">Kategorie aktivieren</span>
                    </label>
                </div>
