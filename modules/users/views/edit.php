<div class="users-edit">
    <div class="page-header">
        <h1 class="page-title">Benutzer bearbeiten: <?= e($user['name']) ?></h1>
        
        <div class="page-actions">
            <a href="<?= route('admin.users.show', ['id' => $user['id']]) ?>" class="btn btn-ghost">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p class="card-subtitle">Ändern Sie die Benutzerdaten</p>
        </div>

        <div class="card-body">
            <form method="POST" action="<?= route('admin.users.update', ['id' => $user['id']]) ?>" class="form">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role" class="form-select <?= isset($errors['role']) ? 'form-select-error' : '' ?>" required>
                        ...
                        <?php foreach ($roles as $value => $label): ?>
                            <option value="<?= e($value) ?>" <?= (old('role', $user['role'] ?? '') === $value) ? 'selected' : '' ?>>
                                <?= e($label) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    <label class="form-checkbox">
                        ...
                        <span class="form-checkbox-label">Benutzer aktiv</span>
                    </label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php endif; ?>
                    <p class="form-hint">Lassen Sie dieses Feld leer, um das Passwort nicht zu ändern.</p>
                </div>
