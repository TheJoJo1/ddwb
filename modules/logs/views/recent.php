...
$title = 'Letzte Protokolleinträge';
?>
...
<div class="page-header">
    <div class="page-header-content">
        <h1>
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 12L14.5 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            Letzte Protokolleinträge
        </h1>
        <p class="page-subtitle">Die letzten <?= e($limit) ?> Aktionen</p>
    </div>
    <div class="page-header-actions">
        ...
        <a href="<?= route('logs.today') ?>" class="btn btn-secondary">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="alert alert-info">
    ...
    <strong>Keine Einträge gefunden.</strong> Es gibt noch keine Protokolleinträge.
</div>
<?php else: ?>

<div class="card">
    <div class="card-header">
        <h2>Letzte <?= e($limit) ?> Einträge</h2>
    </div>
    <div class="card-body">
