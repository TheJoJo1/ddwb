...
$title = 'Protokolleinträge: ' . e($actionOptions[$action] ?? $action);
?>
...
<div class="page-header">
    <div class="page-header-content">
        <h1>
            ...
            Protokolleinträge: <?= e($actionOptions[$action] ?? $action) ?>
        </h1>
        <p class="page-subtitle">Alle Einträge mit der Aktion "<?= e($actionOptions[$action] ?? $action) ?>"</p>
    </div>
...
<div class="alert alert-info">
    ...
    <strong>Keine Einträge gefunden.</strong> Es gibt keine Protokolleinträge mit dieser Aktion.
</div>
<?php else: ?>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= route('logs.byAction', ['action' => $action]) ?>" method="GET" class="form">
                ...
                <div class="form-group">
                    ...
                    <select id="user_id" name="user_id" class="form-select">
                        ...
                        <?php foreach ($users as $user): ?>
                            <option value="<?= e($user['id']) ?>" <?= ($filters['user_id'] ?? '') === $user['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-actions">
                ...
                <a href="<?= route('logs.byAction', ['action' => $action]) ?>" class="btn btn-ghost">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19 12H5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M12 19L5 12L12 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
...
<div class="card">
    ...
    <div class="card-footer">
        <?= render_pagination($pagination, route('logs.byAction', ['action' => $action])) ?>
    </div>
</div>
